...
public final class AoeError extends NamedNumber<Byte, AoeError> {
    ...
    public static final AoeError CMD_UNKNOWN = new AoeError((byte) 1, "Command unrecognized");
    ...
    private static final Map<Byte, AoeError> registry = new HashMap<Byte, AoeError>();
